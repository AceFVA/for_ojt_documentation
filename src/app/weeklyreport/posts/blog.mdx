---
title: "Create, edit and delete weekly report posts"
summary: "Create, edit and delete posts in the weekly report section of your Magic Portfolio."
...
You can create, edit and delete posts by adding, modifying or removing `*.mdx` files in the `src/app/weeklyreport/posts` directory.
...
---`,
        language: "tsx",
        label: "src/app/weeklyreport/posts/post-1.mdx"
      }
    ]}
/>
