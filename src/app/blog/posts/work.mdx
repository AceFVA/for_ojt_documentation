...
You can create, edit and delete projects by adding, modifying or removing `*.mdx` files in the `src/app/requirements/projects` directory.
...
---`,
        language: "tsx",
        label: "src/app/requirements/projects/project-1.mdx"
      }
    ]}
/>
